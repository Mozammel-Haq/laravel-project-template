                ...
                <div class="row">
                    <div class="col-lg-6 p-0">
                        <div class="login-backgrounds d-lg-flex align-items-center justify-content-center d-none flex-wrap p-4 position-relative h-100 z-0">
                            <img src="{{asset('dashboard/assets')}}/img/icons/log-illustration-img-01.png" alt="log-illustration-img-01" class="img-fluid img1">
                        </div>
                    </div> <!-- end row-->
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" value="{{ old('email') }}" class="form-control @error('email') is-invalid @enderror border-start-0 ps-0" placeholder="Enter Email Address" required autocomplete="email" autofocus name="email">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <div class="position-relative">
                                                        <div class="pass-group input-group position-relative border rounded">
                                                            ...
                                                            <input type="password" class="pass-input form-control @error('password') is-invalid @enderror ps-0 border-0"  name="password" placeholder="****************" required autocomplete="current-password">
                                                            <span class="input-group-text bg-white border-0">
...
<!-- jQuery -->
<script src="{{asset('dashboard/assets')}}/js/jquery-3.7.1.min.js" type="2732805a8c33ef7ba1c7249a-text/javascript"></script>

<!-- Bootstrap Core JS -->
<script src="{{asset('dashboard/assets')}}/js/bootstrap.bundle.min.js" type="2732805a8c33ef7ba1c7249a-text/javascript"></script>

<!-- Main JS -->
<script src="{{asset('dashboard/assets')}}/js/script.js" type="2732805a8c33ef7ba1c7249a-text/javascript"></script>

<script src="{{asset('dashboard/assets')}}/js/rocket-loader.min.js" data-cf-settings="2732805a8c33ef7ba1c7249a-|49" defer></script></body>
